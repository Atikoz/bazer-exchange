...
const SubtractFirstCoin = async (firstCoin: string, secondCoin: string, userId: number, percent: number, amount: number): Promise<void> => {
  try {
...
export default SubtractFirstCoin;
