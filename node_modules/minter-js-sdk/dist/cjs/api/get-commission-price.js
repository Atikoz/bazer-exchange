 ...
 */
function GetCommissionPrice(apiInstance, factoryAxiosOptions) {
  /**
  ...
  return function getCommissionPrice(axiosOptions) {
    return apiInstance.get('price_commissions', _objectSpread(_objectSpread({}, factoryAxiosOptions), axiosOptions)).then(function (response) {
      return response.data;
    });
  };
}

module.exports = GetCommissionPrice;
