 ...
 */
function EstimateCoinBuy(apiInstance, factoryAxiosOptions) {
  /**
  ...
  return function estimateCoinBuy(params, axiosOptions) {
    ...
    return apiInstance.get('estimate_coin_buy', _objectSpread(_objectSpread(_objectSpread({}, factoryAxiosOptions), axiosOptions), {}, {
      params: params,
