 ...
 */
function EstimateCoinSell(apiInstance, factoryAxiosOptions) {
  /**
  ...
  return function estimateCoinSell(params, axiosOptions) {
    ...
    return apiInstance.get('estimate_coin_sell', _objectSpread(_objectSpread(_objectSpread({}, factoryAxiosOptions), axiosOptions), {}, {
      params: params,
